...
func SubirAvatar(w http.ResponseWriter, r *http.Request) {
	...
	/*Se procesa como un formulario de hatml, se captuar la variable avatar del formulario
	 */
	...
	/*Ahora debemos actualizar la base de datos agregando el nombre del avatar en el usuario*/
